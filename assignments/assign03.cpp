...
* *
***/
void parseLine(string line, int i, record records[])
{
   string uword;
   string fword;
   string word;
   ...
   if(getword == 0)
   {
      cout <<  "Error parsing line: " << records[i].filename 
      << " " << records[i].username << endl;
   }
   else if(longword[0] != 49)
   {
      cout <<  "Error parsing line: " << records[i].filename 
      << " " << records[i].username 
      << " " << longword << endl;
   }
   else if(atol(longword) < 1000000000)
   {
     cout <<  "Error parsing line: " << records[i].filename 
      << " " << records[i].username 
      << " " << longword << endl;
   ...
   else if(atol(longword) > 10000000000)
   {
      cout <<  "Error parsing line: " << records[i].filename 
      << " " << records[i].username 
      << " " << longword << endl;
